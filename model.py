...
#here we want add attention using CBAM to the original csrnet
#CBAM has channel attention and spatial attention
...
class CSRNet(nn.Module):
    def __init__(self, load_weights=False):
        ...
        if not load_weights:
            ...
            # Load only matching weights from VGG16 into frontend
            vgg_state = mod.features.state_dict()
            frontend_state = self.frontend.state_dict()
